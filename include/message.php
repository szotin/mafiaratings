...
class Tag
{
	...
	// 'url' => new Tag('<a href="#">', '</a>') - '[url=http://www.mafiaratings.com]Mafia[/url] -> <a href="http://www.mafiaratings.com">Mafia</a>. If [url] does not have a corresponding [/url] it auto-adds </a> at the end.
	//
