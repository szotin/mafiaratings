    ...
    function save()
    {
		...
		for ($i = 0; $i < 10; ++$i)
		{
			...
			Db::exec(
				...
				$player->kill_round, $player->kill_type, $player->warnings, $player->arranged, $player->don_check, $player->sheriff_check, $player->won, $player->extra_points, $player->comment);
