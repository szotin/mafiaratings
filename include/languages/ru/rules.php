	...
	(
		...
		(
			...
			(
				...
				array
				(
					'Игрок «убитый» в первую ночь имеет право на «лучший ход». В своей заключительной речи он может назвать трех игроков которых считает мафией. Если он угадает двух, или трех из них, то может получить дополнительные баллы в соответствии с регламентом турнира. Игрок не имеет права на «лучший ход» если по результату голосования в первый день игру покинули 2 или большее количество игроков.',
					'Игрок «убитый» в первую ночь может назвать тройку черных, однако она никак не будет зафиксирована Судьей и не повлияет на результаты турнира.',
				),
				array
				(
					'Принимается.',
	...
	(
		...
		(
			...
			(
				...
				'Влияние на «лучший ход»',
				array
				(
					'Просьба назвать или не называть кого-либо в «лучший ход», выраженная вслух или с помощью жестикуляции. Удаление.',
					'Просьба назвать или не называть кого-либо в «лучший ход», выраженная вслух или с помощью жестикуляции. Фол.',
					'Просьба назвать или не называть кого-либо в «лучший ход», выраженная вслух или с помощью жестикуляции не наказывается.',
				),
				array
				(
					'Удаление.',
			...
			(
				...
				'Ссылка на влияние на «лучший ход»',
				array
				(
					'Апелляция к влиянию на «лучший ход» с целью доказательства игровой роли или объяснения игровых действий. Удаление.',
					'Апелляция к влиянию на «лучший ход» с целью доказательства игровой роли или объяснения игровых действий. Фол.',
					'Апелляция к влиянию на «лучший ход» с целью доказательства игровой роли или объяснения игровых действий не наказывается.',
				),
				array
				(
					'Удаление.',
