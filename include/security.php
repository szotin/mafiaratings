...
define('PERMISSION_EVENT_MODERATOR', 0x0400);      // Users having moderator permission for the event
...
define('PERMISSION_TOURNAMENT_MODERATOR', 0x2000); // Users having moderator permission for the tournament
...
define('PERMISSION_MASK_EVENT', 0x0f00);      // PERMISSION_EVENT_PLAYER | PERMISSION_EVENT_MODERATOR | PERMISSION_EVENT_MANAGER
define('PERMISSION_MASK_TOURNAMENT', 0xf000); // PERMISSION_TOURNAMENT_PLAYER | PERMISSION_TOURNAMENT_MODERATOR | PERMISSION_TOURNAMENT_MANAGER
...
function is_permitted($permissions, $id1 = 0, $id2 = 0, $id3 = 0, $id4 = 0, $id5 = 0)
{
	...
	while ($permissions)
	{
		...
		switch ($flag)
		{
			...
			case PERMISSION_EVENT_MODERATOR:
			...
			case PERMISSION_TOURNAMENT_MODERATOR:
...
// check_permissions(PERMISSION_LEAGUE_MANAGER | TOURNAMENT_MANAGER, $league_id, $tournament_id);
// check_permissions(PERMISSION_OWNER | PERMISSION_CLUB_MODERATOR | EVENT_MODERATOR, $user_id, $club_id, $event_id);
