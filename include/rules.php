...
define('RULES_SPLIT_ON_NINE_ALLOWED', 0); // 7.23.1. Если за столом девять игроков и трое из них дважды набирают одинаковое число голосов, дальше всё происходит как в любом другом раунде. Судья спрашивает кто за то, чтобы все три игрока покинули стол и если больше 4 игроков голосуют за это, оба игрока покидают стол.
define('RULES_SPLIT_ON_NINE_PROHIBITED', 1); // 7.23.2. Если за столом девять игроков и трое из них дважды набирают одинаковое число голосов, дальнейшее голосование не проводится. Судья объявляет «Наступает ночь». Никто не покидает игровой стол.
