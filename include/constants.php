...
define('TOURNAMENT_FLAG_USE_ROUNDS_SCORING', 0x80);
define('TOURNAMENT_FLAG_FINISHED', 0x100);
define('TOURNAMENT_EDITABLE_MASK', 0xf0); // TOURNAMENT_FLAG_LONG_TERM | TOURNAMENT_FLAG_SINGLE_GAME | TOURNAMENT_FLAG_EVENT_ROUND | TOURNAMENT_FLAG_USE_ROUNDS_SCORING
