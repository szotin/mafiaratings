...
define('EVENT_FLAG_AWARD_MVP', 0x800);
define('EVENT_FLAG_AWARD_RED', 0x1000);
define('EVENT_FLAG_AWARD_SHERIFF', 0x2000);
define('EVENT_FLAG_AWARD_BLACK', 0x4000);
define('EVENT_FLAG_AWARD_DON', 0x8000);
define('EVENT_FLAG_AWARD_NO_SHERIFF_IN_RED', 0x10000);
define('EVENT_FLAG_AWARD_NO_DON_IN_BLACK', 0x20000);
define('EVENT_MASK_HIDDEN', 0x3); // EVENT_FLAG_HIDDEN_BEFORE | EVENT_FLAG_HIDDEN_AFTER
define('EVENT_ADMIN_EDITABLE_MASK', 0x200); // EVENT_FLAG_PINNED
define('EVENT_EDITABLE_MASK', 0x3fe28); // EVENT_FLAG_ALL_CAN_REFEREE | EVENT_FLAG_FUN | EVENT_FLAG_PINNED | EVENT_FLAG_STREAMING | EVENT_FLAG_AWARD_MVP | EVENT_FLAG_AWARD_RED | EVENT_FLAG_AWARD_SHERIFF | EVENT_FLAG_AWARD_BLACK | EVENT_FLAG_AWARD_DON | EVENT_FLAG_AWARD_NO_SHERIFF_IN_RED | EVENT_FLAG_AWARD_NO_DON_IN_BLACK
...
define('TOURNAMENT_ADMIN_EDITABLE_MASK', 0x40); // TOURNAMENT_FLAG_PINNED
define('TOURNAMENT_EDITABLE_MASK', 0x1dff7f70); // LONG_TERM | SINGLE_GAME | PINNED | MANUAL_SCORE | AWARD_* | HIDE_MASK_* | FORCE_NUM_PLAYERS | REGISTRATION_CLOSED | STREAMING | AWARD_NO_SHERIFF_IN_RED | AWARD_NO_DON_IN_BLACK | HIDE_FROM_MAIN_PAGE

define('TOURNAMENT_ICON_MASK', 0x7);
define('TOURNAMENT_ICON_MASK_OFFSET', 0);
define('TOURNAMENT_ICON_MAX_VERSION', 7);

define('TOURNAMENT_AWARD_MASK', 0x7c00); // AWARD_MVP | AWARD_RED | AWARD_SHERIFF | AWARD_BLACK | AWARD_DON
...
//  1 - 0x0001 -      1 - MVP
//  2 - 0x0002 -      2 - best civilian player (non-sheriff)
//  3 - 0x0004 -      4 - best sheriff
//  4 - 0x0008 -      8 - best red player (civ+sheriff)
//  5 - 0x0010 -     16 - best maf player (non-don)
//  6 - 0x0020 -     32 - best don
//  7 - 0x0040 -     64 - best black player (maf+don)
define('COMPETITION_MVP', 0x1);
define('COMPETITION_BEST_CIV', 0x2);
define('COMPETITION_BEST_SHERIFF', 0x4);
define('COMPETITION_BEST_RED', 0x8);
define('COMPETITION_BEST_MAF', 0x10);
define('COMPETITION_BEST_DON', 0x20);
define('COMPETITION_BEST_BLACK', 0x40);
...
define('SERIES_ADMIN_EDITABLE_MASK', 0x40); // SERIES_FLAG_PINNED
...
define('BROADCAST_STATUS_NOT_STARTED', 0);
...
// define('GAME_SETTINGS_SIMPLIFIED_CLIENT', 0x1); // not used now. It is set for some users, though.
define('GAME_SETTINGS_START_TIMER', 0x2);
define('GAME_SETTINGS_CHANGE_ROLES_IN_ARRANGEMENT', 0x4);
define('GAME_SETTINGS_NO_BLINKING', 0x8);
define('GAME_SETTINGS_RANDOMIZE_SEATING', 0x10);
define('GAME_SETTINGS_EDITABLE_MASK', 0x1e); // GAME_SETTINGS_START_TIMER | GAME_SETTINGS_CHANGE_ROLES_IN_ARRANGEMENT | GAME_SETTINGS_NO_BLINKING | GAME_SETTINGS_RANDOMIZE_SEATING

define('UPDATE_FLAG_EVENT', 1);
define('UPDATE_FLAG_TOURNAMENT', 2);
define('UPDATE_FLAG_CLUB', 4);
?>
