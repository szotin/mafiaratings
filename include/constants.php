...
define('TOURNAMENT_FLAG_ENFORCE_RULES', 0x80);
define('TOURNAMENT_FLAG_ENFORCE_SCORING', 0x100);
define('TOURNAMENT_FLAG_FINISHED', 0x200);
define('TOURNAMENT_EDITABLE_MASK', 0x1f0); // TOURNAMENT_FLAG_LONG_TERM | TOURNAMENT_FLAG_SINGLE_GAME | TOURNAMENT_FLAG_EVENT_ROUND | TOURNAMENT_FLAG_ENFORCE_RULES | TOURNAMENT_FLAG_ENFORCE_SCORING
