...
/*		echo '<pre>';
		...
		Db::exec(
			...
			$this->scoring_id, $this->scoring_version, $this->scoring_weight);
	...
	static function show_buttons($id, $start_time, $duration, $flags, $club_id, $club_flags, $attending)
	{
		...
		if ($start_time < $now)
		{
			echo '<button class="icon" onclick="window.open(\'event_figm_form.php?event_id=' . $id . '\' ,\'_blank\')" title="' . get_label('FIGM report.') . '"><img src="images/figm.png" border="0"></button>';
		}
