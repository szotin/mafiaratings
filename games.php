...
class Page extends GeneralPageBase
{
	...
	protected function show_body()
	{
		...
		echo '<tr class="th darker"><td width="90">&nbsp;</td><td>'.get_label('Club').'</td><td width="100">'.get_label('Moderator').'</td><td width="140">'.get_label('Start time').'</td><td width="60">'.get_label('Duration').'</td><td width="100">'.get_label('Result').'</td></tr>';
		$query = new DbQuery(
