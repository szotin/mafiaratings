...
class Page extends LeaguePageBase
{
	...
	// {
		...
		// {
			// list ($event_id, $event_name, $event_flags, $event_time, $timezone, $league_id, $league_name, $league_flags, $addr_id, $addr_flags, $addr, $addr_name) = $row;
			// if ($colunm_count == 0)
			// {
				// if ($event_count == 0)
				// {
	...
	protected function show_body()
	{
		...
		// if ($_profile != NULL)
		// {
			// $is_manager = $_profile->is_league_manager($this->id);
		// }
