...
class Page extends EventPageBase
{
	protected function show_body()
	{
		...
		$query = new DbQuery(
			'SELECT g.id, ct.timezone, m.id, m.name, m.flags, g.start_time, g.end_time - g.start_time, g.result, g.video_id, g.non_rating, g.canceled, t.id, t.name, t.flags, l.id, l.name, l.flags FROM games g' .
		...
		{
			list ($game_id, $timezone, $moder_id, $moder_name, $moder_flags, $start, $duration, $game_result, $video_id, $is_non_rating, $is_canceled, $tournament_id, $tournament_name, $tournament_flags, $league_id, $league_name, $league_flags) = $row;
