...
echo '#1#';
echo get_label('Windows standalone client is not supported any more. Please use web page http://mafiaratings.com/game.php instead. Sorry for the inconvinience.');
echo '#';
?>