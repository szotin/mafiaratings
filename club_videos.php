...
class Page extends ClubPageBase
{
	...
	protected function show_body()
	{
		...
		list ($count) = Db::record(get_label('video'), 'SELECT count(*) FROM videos v WHERE v.club_id = ?', $this->id, $condition);
		...
		if ($can_add)
		{
			...
			echo '<tr><td align="center" width="' . COLUMN_WIDTH . '%"><a href="#" onclick="mr.createVideo(' . $this->video_type . ', ' . $this->id , ', null, null)">';
		...
		$query = new DbQuery(
			...
			' WHERE v.club_id = ?', $this->id, $condition);
