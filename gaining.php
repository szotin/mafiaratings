...
class Page extends GeneralPageBase
{
	...
	protected function show_body()
	{
		...
		echo '<tr><td><input type="number" style="width: 45px;" step="1" min="1" max="10" id="form-stars" value="' . $this->stars . '" onChange="onChangeParams()"> ' . get_label('stars') . '</td>';
		echo '<td><input type="number" style="width: 45px;" step="1" min="10" id="form-players" value="' . $this->players . '" onChange="onChangeParams()"> ' . get_label('players') . '</td></tr>';
		echo '</table>';
		
		$points = get_gaining_points($this->gaining, $this->stars, $this->players);
