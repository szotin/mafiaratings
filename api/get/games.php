...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('series_id', 'Series id. For example: <a href="games.php?series_id=1"><?php echo PRODUCT_URL; ?>/api/get/games.php?series_id=1</a> returns all games played in American Mafia League 2022 season. <a href="games.php?series_id=0"><?php echo PRODUCT_URL; ?>/api/get/games.php?series_id=0</a> returns all games that were played outside of any series.', '-');
