...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('rules_code', 'Rules code. For example: <a href="games.php?rules_code=' . DEFAULT_RULES . '">' . PRODUCT_URL . '/api/get/games.php?rules_code=' . DEFAULT_RULES . '</a> returns all games played by the rules with the code ' . DEFAULT_RULES . ' was used. Please check <a href="rules.php?help">' . PRODUCT_URL . '/api/get/rules.php?help</a> for the meaning of rules codes and getting rules list.', '-');
