...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('in_langs', 'Languages filter. 1 for English; 2 for Russian. Bit combination - 3 - means both (this is a default value). For example: <a href="ratings.php?in_langs=1">' . PRODUCT_URL . '/api/get/ratings.php?in_langs=1</a> returns rating points earned in games played in English; <a href="ratings.php?club=1&in_langs=3">' . PRODUCT_URL . '/api/get/ratings.php?club=1&in_langs=3</a> returns rating points earned in English and Russian games by the players of Vancouver club.', '-');
		...
		$help->request_param('page_size', 'Page size. Default page_size is 16. For example: <a href="ratings.php?club=1&page_size=32">' . PRODUCT_URL . '/api/get/ratings.php?club=1&page_size=32</a> returns top 32 players for Vancouver Mafia Club; <a href="ratings.php?club=6&page_size=0">' . PRODUCT_URL . '/api/get/ratings.php?club=6&page_size=0</a> returns all players for Empire of Mafia club in one page; <a href="ratings.php?club=1">' . PRODUCT_URL . '/api/get/ratings.php?club=1</a> returns top 16 players for Vancouver Mafia Club;', '-');
