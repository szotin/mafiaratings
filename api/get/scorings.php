...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('scoring_id', 'Scoring system id. For example: <a href="scorings.php?scoring_id=19">/api/get/scorings.php?scoring_id=19</a> returns information about FIIM scoring system.', '-');
		$help->request_param('scoring_version', 'Scoring system version. For example: <a href="scorings.php?scoring_id=21&scoring_version=1">/api/get/scorings.php?scoring_id=21&scoring_version=1</a> returns information about VaWaCa scoring system version 1 (current version is 2). When 0, the latest version is returned.', 'all versions are returned');
		$help->request_param('club_id', 'Club id. Returns all scoring systems used in this club. For example: <a href="scorings.php?club_id=1">/api/get/scorings.php?club_id=1</a> returns all scoring systems used in Vancouver Mafia Club.', '-');
		$help->request_param('league_id', 'League id. Returns all scoring systems used in this league. For example: <a href="scorings.php?league_id=2">/api/get/scorings.php?league_id=2</a> returns all scoring systems used in American Mafia League.', '-');
