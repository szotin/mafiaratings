...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('scoring_id', 'Scoring system id. For example: <a href="scorings.php?scoring_id=19"><?php echo PRODUCT_URL; ?>/api/get/scorings.php?scoring_id=19</a> returns information about FIIM scoring system.', '-');
