...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('page_size', 'Page size. Default page_size is ' . DEFAULT_PAGE_SIZE . '. For example: <a href="events.php?page_size=32">' . PRODUCT_URL . '/api/get/events.php?page_size=32</a> returns first 32 events; <a href="events.php?page_size=0">' . PRODUCT_URL . '/api/get/events.php?page_size=0</a> returns events in one page; <a href="events.php">' . PRODUCT_URL . '/api/get/events.php</a> returns first ' . DEFAULT_PAGE_SIZE . ' events by alphabet.', '-');
