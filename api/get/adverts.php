...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('page_size', 'Page size. Default page_size is ' . API_DEFAULT_PAGE_SIZE . '. For example: <a href="adverts.php?club=1&page_size=32"><?php echo PRODUCT_URL; ?>/api/get/adverts.php?club=1&page_size=32</a> returns last 32 advertizements for Vancouver Mafia Club; <a href="adverts.php?club=6&page_size=0"><?php echo PRODUCT_URL; ?>/api/get/adverts.php?club=6&page_size=0</a> returns all advertizements for Empire of Mafia club in one page; <a href="adverts.php?club=1"><?php echo PRODUCT_URL; ?>/api/get/adverts.php?club=1</a> returns last ' . API_DEFAULT_PAGE_SIZE . ' advertizements for Vancouver Mafia Club;', '-');
