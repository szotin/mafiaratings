...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('page_size', 'Page size. Default page_size is 16. For example: <a href="countries.php?page_size=32"><?php echo PRODUCT_URL; ?>/api/get/countries.php?page_size=32</a> returns first 32 countries; <a href="countries.php?page_size=0"><?php echo PRODUCT_URL; ?>/api/get/countries.php?page_size=0</a> returns countries in one page; <a href="countries.php"><?php echo PRODUCT_URL; ?>/api/get/countries.php</a> returns first 16 countries by alphabet.', '-');
