...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('normalizer_id', 'normalizer system id. For example: <a href="normalizers.php?normalizer_id=19"><?php echo PRODUCT_URL; ?>/api/get/normalizers.php?normalizer_id=19</a> returns information about FIGM normalizer system.', '-');
