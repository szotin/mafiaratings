...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('user_id', 'User id. For example: <a href="clubs.php?user_id=25"><?php echo PRODUCT_URL; ?>/api/get/clubs.php?user_id=25</a> returns all clubs where Fantomas is a member.', '-');
		...
		$help->request_param('rules_code', 'Rules code. For example: <a href="clubs.php?rules_code=00100000000000000100000001111">' . PRODUCT_URL . '/api/get/clubs.php?rules_code=00100000000000000100000001111</a> returns all clubs using the rules with the code 00000000100101010200000000000. Please check <a href="rules.php?help">' . PRODUCT_URL . '/api/get/rules.php?help</a> for the meaning of rules codes and getting rules list.', '-');
