...
class ApiPage extends GetApiPageBase
{
	...
	protected function get_help()
	{
		...
		$help->request_param('rules_code', 'Rules code. For example: <a href="clubs.php?rules_code=00020000100000">' . PRODUCT_URL . '/api/get/clubs.php?rules_code=00020000100000</a> returns all clubs using the rules with the code 00020000100000. Please check <a href="rules.php?help">' . PRODUCT_URL . '/api/get/rules.php?help</a> for the meaning of rules codes and getting rules list.', '-');
