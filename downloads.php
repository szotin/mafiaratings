...
class Page extends GeneralPageBase
{
	protected function show_body()
	{
		...
		show_row('downloads/' . PRODUCT_TERM . 'Setup.msi', get_label('[0] for Windows 2000/XP/7', PRODUCT_NAME), get_label('multilanguage'));
		show_row('downloads/' . PRODUCT_TERM . 'Setup.ru.msi', get_label('[0] for Windows 2000/XP/7', PRODUCT_NAME), get_label('Russian'));
		echo '</table>';
	}
}
