...
try
{
	...
	if ($game_id > 0)
	{
		list ($tournament_name, $event_name, $json, $timezone, $moder_name, $feature_flags) = Db::record(get_label('game'), 
			'SELECT t.name, e.name, g.json, c.timezone, nu.name, g.feature_flags FROM games g' .
